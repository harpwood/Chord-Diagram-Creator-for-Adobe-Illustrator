...
Know issue: if you create a chord with empty name throws a silent exception error and draws only the base diagram (strings and frets). It will be fixed in the next update.
